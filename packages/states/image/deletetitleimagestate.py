        ...
        # only accept "/previewpostimage <image_id>" callback queries
            ...
            if post is not None:
                ...
                if image is not None:
                    self.bot.send_photo(chat_id, image.thumb_id if image.thumb_id else image.file_id,
                ...
                next_state = DeleteTitleImageState(self.bot, user_id, post.id, chat_id=chat_id)
